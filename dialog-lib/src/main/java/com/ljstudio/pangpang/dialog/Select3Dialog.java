...
import com.ljstudio.pangpang.dialog.view.BouncingListView;
...
public class Select3Dialog extends BaseDialog implements CommonListAdapter.ViewFormatter<String> {
    ...
    public Select3Dialog(Context context, IListener listener, String title) {
        this(context, listener, title, R.color.dialog_select_color,R.mipmap.dialog_select_box);
    ...
    public Select3Dialog(Context context, IListener listener, String title, List<String> itemsFirst, List<String> itemsSecond, List<String> itemsThird) {
        this(context, listener, title, R.color.dialog_select_color,R.mipmap.dialog_select_box, itemsFirst, itemsSecond, itemsThird);
    }
    ...
    public void setItems(List<String> sources, int selection) {
        ...
        items.add("");
        items.add("");
        adapterFirst = new CommonListAdapter<String>(getContext(), itemsFirst, null, R.layout.dialog_item_select, 0, this);
        listFirst.setVisibility(View.VISIBLE);
    ...
    public void setItems2(List<String> sources, int selection) {
        ...
        items.add("");
        items.add("");
        adapterSecond = new CommonListAdapter<String>(getContext(), itemsSecond, null, R.layout.dialog_item_select, 0, this);
        listSecond.setVisibility(View.VISIBLE);
